...
methods_file = open("etsy_py/methods.py", "r")
...
with open("etsy_py/methods.py", "w") as build_file:
    file_header_lines = [
...
with open("etsy_py/base_client.pyi", "r") as base_client_stub:
    with open("etsy_py/client.pyi", "w") as build_file:
